...
feature 'Visitor visit homepage' do
  ...
  scenario 'and view recipe' do
    ...
    recipe = Recipe.create!(title: 'Bolo de cenoura', difficulty: 'Médio',
                           ...
                           cook_time: 50,
                           ingredients: 'Farinha, açucar, cenoura, cenoura, cenoura',
  ...
  scenario 'and view recipes list' do
    ...
    recipe_type = RecipeType.create(name: 'Sobremesa')
    user = User.create!(email: 'teste@teste.com', password: 'teste123', role: :user)
    another_recipe_type = RecipeType.create(name: 'Prato principal 3')
    recipe = Recipe.create!(title: 'Bolo de cenoura', difficulty: 'Médio',
                           recipe_type: recipe_type, cuisine: 'Italiana',
                           cook_time: 50,
                           ingredients: 'Farinha, açucar, cenoura',
                           cook_method: 'Cozinhe a cenoura, corte em pedaços pequenos, misture com o restante dos ingredientes',
                           user: user, status: :rejected)

    another_recipe = Recipe.create!(title: 'Feijoada da vovó', difficulty: 'Difícil',
                                   recipe_type: another_recipe_type, cuisine: 'Brasileira',                                    
                                   cook_time: 90,
                                   ingredients: 'Feijão e carnes junto com linguiça e laranja',
